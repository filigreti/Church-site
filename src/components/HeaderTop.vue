<template>
  ...
  >
    <div class="cursor-pointer flex items-center" @click="$router.push('/')">
      <img
        class="w-12 -ml-4 h-12 object-contain"
    ...
    <ul class="lg:flex lg:text-white lg:items-center hidden">
      ...
      <div
        class="ml-10 cursor-pointer relative text-gray-500 font-hairline hover:text-white text-xs events"
        :class="[$route.name == 'MainTheme' ? 'all-white' : '']"
      >
        <span
          @click="eventDropDown = !eventDropDown"
          class="flex items-center hover:text-white"
        >
          <div
            :class="
              $route.name == 'MainEvent' || $route.name == 'Pledge'
                ? 'text-white'
                : ''
            "
          >
        ...
        <div
          v-if="eventDropDown"
          class="-ml-10 mt-1 flex shadow-sm flex-col opacity-75 p-1 rounded-md w-32 bg-gray-800 absolute"
        >
          <router-link class=" border-b border-gray-900 py-1" to="/events"
            >Events</router-link
          >
          <router-link class="py-1" to="/pledge">Pledge</router-link>
        </div>
      </div>
      <li class="ml-10">
        <router-link
      ...
      <div class="m-8 w-full relative">
        <div class="justify-between flex w-full">
          <div class="z-20 cursor-pointer" @click="$router.push('/')">
            ...
            <p class="text-xs capitalize text-white lg:mt-2 lg:pt-1 pt-2">
              We care, because God Cares
            </p>
          </div>
          <div class="z-20">
