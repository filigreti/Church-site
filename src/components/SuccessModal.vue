<template>
  <main>
    <div
      class="fixed inset-0 w-full lg:px-0 px-3 z-20 bg-black bg-opacity-75 overflow-y-auto flex justify-center items-center pt-8"
    >
      <div class="lg:max-w-2xl w-full p-5 bg-white relative">
        <div @click="close">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            class="w-5 h-5 absolute top-0 right-0 mt-5 mr-5"
            viewBox="0 0 512 512"
          >
            <path
        ...
        <p
          class="text-xs text-center text-gray-600 font-light lg:px-24 py-2"
        >Please save your Registration Number and your Bible Study group to be requested during the program</p>
        <div class="lg:mx-10 p-3 border border-black my-5 rounded-lg text-center">
