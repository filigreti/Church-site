<template>
  <main>
    ...
    <div class="text-center">
      ...
      >{{subText}}</p>
      <div v-if="donations" class="text-gray-500 font-light text-xs mt-1">
        {{donations}}
    ...
    <div v-if="screen == 'Home'" class>
      ...
      >
        <div class="inline-flex shadow items-center flex-col cursor-pointer">
          <svg
      ...
      >
        ...
        <div
          @click="$router.push('/media/books/cart')"
          class="inline-flex items-center flex-col cursor-pointer"
        >
          <svg
            class="h-12 w-12 text-blue-600 mt-4"
      ...
      >
        ...
        <div class="flex items-center">
          ...
          <div class="ml-2">
            ...
            <p class="font-light text-xs text-gray-600">Thursday, 3.00 PM</p>
          </div>
        </div>
        <div class="flex items-center">
          <svg
