<template>
  <main>
    <div :class="[color]" class="h-60 w-full absolute top-0" style="z-index:-1">
      <img style="opacity:.4" :class="[position]" class="h-full w-full object-cover" :src="bgImage" alt />
    </div>

    <div class="text-center">
      <h1 class="uppercase font-light play text-2xl pt-8 text-white lg:pt-16 tracking-wider leading-10 lg:leading-10 lg:text-4xl">{{ mainText }}</h1>
      <p v-if="screen != 'Salvations'" :class="subTextClass" class="lg:max-w-2xl mt-2 leading-6 tracking-tight text-gray-300 text-sm lg:mx-auto mx-5 font-light">{{ subText }}</p>
      <div v-else class=" lg:text-center  mb-32 lg:px-24 px-4  mt-2 leading-6 tracking-tight text-gray-300 text-xs lg:mx-auto font-light">
        <p>Choosing to receive Jesus Christ as your Lord and Saviour is the most important decision you'll ever make</p>
        <p class="mt-2">If thou shalt confess with thy mouth the Lord Jesus, and shalt believe in thine heart that God hath raised him from the dead, thou shalt be saved. For with the heart man believeth unto righteousness; and with the mouth confession is made unto salvation... For whosoever shall call upon the name of the Lord shall be saved.</p>
      </div>
      <div v-if="donations" class="text-gray-500 font-light text-xs mt-1 lg:mx-0 mx-6">
        {{ donations }}
        <p>We care because God's care</p>
      </div>
      <button @click="modalShow" :class="button" :style="!buttonText ? check : ''" class="text-sm rounded-full bg-transparent hover:bg-white text-white font-light hover:text-gray-800 outline-none shadow-none focus:outline-none py-2 leading-7 px-12 mt-6 border border-white hover:border-transparent rounded">{{ buttonText }}</button>
    </div>

    <div v-if="screen == 'Home'" class>
      <div style="grid-template-columns:1fr 1fr" class="grid box-border lg:hidden mt-20 gap-2 container px-3">
        <div @click="$router.push('/bible-school')" class="inline-flex shadow items-center flex-col cursor-pointer">
          <svg class="h-12 w-12 text-blue-600 mt-4" xmlns="http://www.w3.org/2000/svg" id="Capa_1" enable-background="new 0 0 512 512" height="512px" viewBox="0 0 512 512" width="512px">
            <g>
              <g>
                <g>
                  <g>
                    <path d="m146.62 195.45c-4.171 0-8.016-2.697-9.415-6.631-1.398-3.933-.169-8.449 3.071-11.096 3.285-2.684 8.015-2.986 11.62-.758 3.594 2.22 5.427 6.65 4.453 10.761-1.057 4.466-5.128 7.724-9.729 7.724z" data-original="#000000" class="active-path" data-old_color="#000000" fill="#4299e1" />
                  </g>
                  <g>
                    <path
        ...
        <div @click="$router.push('/media')" class="inline-flex shadow items-center flex-col cursor-pointer">
          <svg class="h-12 w-12 text-blue-600 mt-4" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 512.001 512.001" style="enable-background:new 0 0 512.001 512.001;" xml:space="preserve">
            ...
            <g>
              <g>
                <path fill="#4299e1" d="M150.072,329.154c-5.855-5.856-15.351-5.856-21.207,0l-21.207,21.207c-5.856,5.856-5.856,15.351,0,21.207    c5.855,5.856,15.352,5.856,21.207,0l21.207-21.207C155.928,344.505,155.928,335.01,150.072,329.154z" />
              </g>
            </g>
            <g>
              <g>
                <path fill="#4299e1" d="M346.19,0c-8.282,0-14.996,6.714-14.996,14.996v29.992c0,8.282,6.714,14.996,14.996,14.996s14.996-6.714,14.996-14.996    V14.996C361.186,6.714,354.472,0,346.19,0z" />
              </g>
            </g>
            <g>
              <g>
                <path fill="#4299e1" d="M466.157,119.966h-29.992c-8.282,0-14.996,6.714-14.996,14.996s6.714,14.996,14.996,14.996h29.992    c8.282,0,14.996-6.714,14.996-14.996S474.438,119.966,466.157,119.966z" />
              </g>
            </g>
            <g>
              <g>
                <path fill="#4299e1" d="M446.769,34.383c-5.855-5.856-15.351-5.856-21.207,0L395.57,64.375c-5.856,5.856-5.856,15.351,0,21.207    c5.855,5.856,15.351,5.857,21.207,0l29.992-29.992C452.625,49.734,452.625,40.24,446.769,34.383z" />
              </g>
            </g>
            <g />
            <g />
        ...
        <div @click="$router.push('/testimonies')" class="inline-flex shadow items-center flex-col cursor-pointer">
          <svg class="h-12 w-12 text-blue-600 mt-4" xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1" viewBox="0 0 512 512" width="512px" height="512px">
            <g>
              <path
              ...
              <path
                ...
                fill="#4299e1"
              />
              <path d="M256,187.146a48.164,48.164,0,0,0-48.109,48.11v28.073a48.109,48.109,0,1,0,96.218,0V235.256A48.164,48.164,0,0,0,256,187.146Zm36.109,76.183a36.109,36.109,0,1,1-72.218,0V235.256a36.109,36.109,0,1,1,72.218,0Z" data-original="#000000" class="active-path" data-old_color="#000000" fill="#4299e1" />
              <path d="M405.3,210.936a44.331,44.331,0,0,0-44.281,44.281v25.52a44.281,44.281,0,1,0,88.562,0v-25.52A44.331,44.331,0,0,0,405.3,210.936Zm32.281,69.8a32.281,32.281,0,1,1-64.562,0v-25.52a32.281,32.281,0,1,1,64.562,0Z" data-original="#000000" class="active-path" data-old_color="#000000" fill="#4299e1" />
              <path
                ...
                fill="#4299e1"
              />
              <path d="M62.422,255.217v25.52a44.281,44.281,0,1,0,88.562,0v-25.52a44.281,44.281,0,0,0-88.562,0Zm76.562,0v25.52a32.281,32.281,0,1,1-64.562,0v-25.52a32.281,32.281,0,0,1,64.562,0Z" data-original="#000000" class="active-path" data-old_color="#000000" fill="#4299e1" />
            </g>
          </svg>
          <p class="text-xs text-blue-500 py-4">Testimonies</p>
        </div>
        <div @click="$router.push('/donations')" class="inline-flex shadow items-center flex-col cursor-pointer">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-12 w-12 text-blue-600 mt-4" id="Capa_1" enable-background="new 0 0 512 512" height="512px" viewBox="0 0 512 512" width="512px">
            <g>
              <g>
                <g>
                  <path
                  ...
                  <path
                    ...
                    fill="#4299e1"
                  />
                  <path d="m451.268 142.933c5.522 0 10-4.477 10-10s-4.478-10-10-10h-26.26c-5.522 0-10 4.477-10 10v62.319c0 5.523 4.478 10 10 10h26.26c5.522 0 10-4.477 10-10s-4.478-10-10-10h-16.26v-11.16h14.323c5.522 0 10-4.477 10-10s-4.478-10-10-10h-14.323v-11.16h16.26z" data-original="#000000" class="active-path" data-old_color="#000000" fill="#4299e1" />
                  <path
                    ...
                    fill="#4299e1"
                  />
                  <path d="m380.474 205.252c5.522 0 10-4.477 10-10v-52.894h7.437c5.522 0 10-4.477 10-10s-4.478-10-10-10h-34.733c-5.522 0-10 4.477-10 10s4.478 10 10 10h7.297v52.894c-.001 5.523 4.476 10 9.999 10z" data-original="#000000" class="active-path" data-old_color="#000000" fill="#4299e1" />
                  <path d="m120.336 163.805c0 22.854 18.593 41.447 41.447 41.447s41.446-18.593 41.446-41.447-18.593-41.447-41.446-41.447c-22.854 0-41.447 18.593-41.447 41.447zm62.894 0c0 11.826-9.621 21.447-21.446 21.447-11.826 0-21.447-9.621-21.447-21.447s9.621-21.447 21.447-21.447c11.824 0 21.446 9.622 21.446 21.447z" data-original="#000000" class="active-path" data-old_color="#000000" fill="#4299e1" />
                  <path d="m246.95 61.19c1.609 3.863 5.539 6.354 9.719 6.157 4.113-.194 7.769-3.011 9.031-6.926 1.278-3.966-.111-8.465-3.434-10.992-3.382-2.573-8.093-2.717-11.636-.379-3.944 2.601-5.46 7.796-3.68 12.14z" data-original="#000000" class="active-path" data-old_color="#000000" fill="#4299e1" />
                </g>
              </g>
            </g>
          </svg>
      ...
      <div class="max-w-4xl px-8 py-4 shadow-xl rounded-lg mt-12 bg-white mx-auto justify-evenly h-38 hidden lg:flex">
        <div @click="$router.push('/bible-school')" class="inline-flex items-center flex-col cursor-pointer">
          <svg class="h-12 w-12 text-blue-600 mt-4" xmlns="http://www.w3.org/2000/svg" id="Capa_1" enable-background="new 0 0 512 512" height="512px" viewBox="0 0 512 512" width="512px">
            <g>
              <g>
                <g>
        ...
        <div @click="$router.push('/testimonies')" class="inline-flex items-center flex-col cursor-pointer">
          <svg class="h-12 w-12 text-blue-600 mt-4" xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1" viewBox="0 0 512 512" width="512px" height="512px">
            <g>
              <path
                d="M222.606,123.454l-5.8,33.311a6,6,0,0,0,8.69,6.345l29.965-15.661,29.889,15.806a6,6,0,0,0,8.721-6.3l-5.635-33.338,24.268-23.542a6,6,0,0,0-3.3-10.242L275.96,84.887,261.07,54.531a6,6,0,0,0-5.372-3.357h-.015a6,6,0,0,0-5.374,3.332L235.273,84.788,201.8,89.569a6,6,0,0,0-3.35,10.226Zm17.486-27.232a6,6,0,0,0,4.526-3.272l11.033-22.219L266.576,93a6,6,0,0,0,4.509,3.293l24.542,3.626L277.82,117.2a6,6,0,0,0-1.738,5.307l4.135,24.461-21.931-11.6a6,6,0,0,0-5.584-.013l-21.986,11.49,4.253-24.441a6,6,0,0,0-1.713-5.314l-17.722-17.36Z"
        ...
        <div @click="$router.push('/donations')" class="inline-flex items-center flex-col cursor-pointer">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-12 w-12 text-blue-600 mt-4" id="Capa_1" enable-background="new 0 0 512 512" height="512px" viewBox="0 0 512 512" width="512px">
            <g>
              <g>
                <g>
        ...
        <div @click="$router.push('/salvations')" class="inline-flex items-center flex-col cursor-pointer">
          <svg class="h-12 w-12 fill-current text-blue-600 mt-4" xmlns="http://www.w3.org/2000/svg" id="Capa_1" enable-background="new 0 0 512 512" viewBox="0 0 512 512">
            <g>
              <g>
                <path
                ...
                />
                <path d="m317.372 79.889v-30h-46.651v-48.569h-30v48.569h-46.65v30h46.65v122.42h30v-122.42z" />
              </g>
              <path
          ...
          <p class="text-xs text-blue-500 py-4">Salvations</p>
        </div>
      </div>
    </div>
    <div>
      <div v-if="screen == 'Views'">
        <div v-for="(events, i) in allEvents.results" :key="i" @click="next(events.slug)" class="lg:max-w-4xl px-8 mb-20 relative py-4 shadow-xl rounded-lg mt-12 bg-white mx-auto lg:flex hidden items-center justify-between h-38">
          <div class="absolute rounded-full w-20 h-20 bg-white shadow-2xl flex items-center justify-center -mt-24">
          ...
          <div v-if="events.event_time !== null" class="flex items-center">
            ...
            <div class="ml-2">
              ...
              <p class="font-light text-sm text-gray-600">{{ events.event_start_date | convertWeekend }}, {{ events.event_time | convertHour }}</p>
            </div>
          </div>
          <div class="flex items-center">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10" id="Capa_1" enable-background="new 0 0 512 512" height="512px" viewBox="0 0 512 512" width="512px">
              <g>
                <g>
                  <path
        ...
        <div v-for="(events, i) in allEvents.results" :key="`mobile${i}`" @click="next(events.slug)" class="lg:hidden mt-10">
          <div class="relative shadow-sm rounded-lg bg-white flex h-auto mb-16 mx-3">
            <div class="absolute flex justify-center w-full">
              <div class="rounded-full w-20 h-20 bg-white shadow-2xl flex items-center justify-center -mt-12">
                <div class="inline-flex flex-col items-center">
                  <h1 style="color:red" class="text-2xl font-black leading-none tracking-wider">{{ events.event_start_date | convertDate }}</h1>
                  <h2 class="text-blue-500 font-normal tracking-wide leading-none">{{ events.event_start_date | convertMonth }}</h2>
                </div>
            ...
            <div class="flex flex-col px-5 pt-10 pb-8 w-full items-center">
              ...
              <div v-if="events.event_time !== null" class="flex items-center mt-2">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" id="Capa_1" enable-background="new 0 0 443.294 443.294" height="512px" viewBox="0 0 443.294 443.294" width="512px">
                  <g>
                ...
                <div class="ml-2 flex items-center">
                  ...
                  <p class="font-light text-sm ml-1 text-gray-600">{{ events.event_start_date | convertWeekend }}</p>
                </div>
              </div>
              <div class="flex items-center mt-2">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" id="Capa_1" enable-background="new 0 0 512 512" height="512px" viewBox="0 0 512 512" width="512px">
                  <g>
                    <g>
                      <path
                        d="m354.32 152.519c-8.289-5.526-81.705-54.47-90-60-5.039-3.358-11.602-3.358-16.641 0-8.291 5.528-81.713 54.476-90 60-6.894 4.596-8.756 13.909-4.16 20.801 4.596 6.894 13.911 8.756 20.801 4.161l6.68-4.453v82.972c0 8.284 6.716 15 15 15h120c8.284 0 15-6.716 15-15v-82.972l6.68 4.453c6.882 4.586 16.198 2.744 20.801-4.161 4.595-6.892 2.733-16.205-4.161-20.801zm-53.32 88.481h-90v-87.972l45-30 45 30z"
              ...
              <div class="py-2 px-4 mt-3 rounded-full flex items-center justify-center border border-red-500">
                <p class="text-red-500 uppercase font-light cursor-pointer">Register</p>
              </div>
            </div>
          </div>
    ...
    <div v-if="screen == 'Contact'" class>
      <div style="grid-template-columns:1fr" class="grid box-border lg:hidden mt-40 gap-2 container px-3">
        <div class="inline-flex shadow items-center flex-col p-6">
          ...
          <div class="flex">
            <svg class="w-10 h-10" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 299.997 299.997" style="enable-background:new 0 0 299.997 299.997;" xml:space="preserve" width="512px" height="512px">
              <g>
                <g>
                  <g>
                    <path
            ...
            <div class="ml-2">
              ...
              <p class="text-gray-600 font-light text-xs tracking-tight">admin@godscaremissioninc.org</p>
            </div>
          </div>
        </div>
        <div class="inline-flex shadow items-center flex-col p-6">
          ...
          <div class="flex items-start">
            <svg class="w-10 h-10 -ml-4" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve" width="512px" height="512px">
              <g>
                <g>
                  <g>
                    <path
        ...
        <div class="inline-flex shadow items-center flex-col p-6">
          ...
          <div class="flex items-center justify-center w-full">
            <svg @click="facebook" xmlns="http://www.w3.org/2000/svg" class="h-10 w-10 cursor-pointer" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 112.196 112.196" style="enable-background:new 0 0 112.196 112.196;" xml:space="preserve" width="512px" height="512px">
              <g>
                <g>
                  <circle style="fill:#3B5998;" cx="56.098" cy="56.098" r="56.098" data-original="#3B5998" />
                  <path style="fill:#FFFFFF" d="M70.201,58.294h-10.01v36.672H45.025V58.294h-7.213V45.406h7.213v-8.34   c0-5.964,2.833-15.303,15.301-15.303L71.56,21.81v12.51h-8.151c-1.337,0-3.217,0.668-3.217,3.513v7.585h11.334L70.201,58.294z" data-original="#FFFFFF" class="active-path" data-old_color="#FFFFFF" />
                </g>
              </g>
            </svg>
            <svg @click="twitter" class="h-10 w-10 mx-2 cursor-pointer" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 112.197 112.197" style="enable-background:new 0 0 112.197 112.197;" xml:space="preserve">
              <g>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10 cursor-pointer" height="512pt" viewBox="0 0 512 512" width="512pt">
            ...
            <svg @click="youtube" class="h-10 w-10 ml-2 cursor-pointer" xmlns="http://www.w3.org/2000/svg" height="512px" viewBox="0 0 512 512" width="512px">
              <g>
                <path d="m224.113281 303.960938 83.273438-47.960938-83.273438-47.960938zm0 0" data-original="#000000" class="active-path" data-old_color="#000000" fill="#FF0100" />
                <path
      ...
      <div class="max-w-4xl px-8 py-4 shadow-xl rounded-lg mt-12 bg-white mx-auto justify-evenly h-38 hidden lg:flex">
        ...
        <div class="inline-flex items-center flex-col">
          ...
          <div class="flex items-start">
            <svg class="w-10 h-10" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve" width="512px" height="512px">
              <g>
                <g>
                  <g>
                    <path
    ...
    <div v-if="screen == 'media'" class>
      <div id="mobile-media" style="grid-template-columns:1fr 1fr" class="grid box-border lg:hidden mt-40 gap-2 container px-3">
        <div class="inline-flex shadow items-center justify-center flex-col py-5">
          <router-link to="/media/audio">
            <svg class="h-8 w-8 text-blue-500" xmlns="http://www.w3.org/2000/svg" id="Capa_1" enable-background="new 0 0 512.098 512.098" height="512px" viewBox="0 0 512.098 512.098" width="512px">
              <g>
                <g>
                  <path d="m245.491 245.396-40 40c-5.858 5.857-5.858 15.355 0 21.213 5.858 5.859 15.355 5.858 21.213 0l40-40c5.858-5.857 5.858-15.355 0-21.213-5.857-5.857-15.355-5.857-21.213 0z" data-original="#000000" class="active-path" data-old_color="#000000" fill="#2b6cb0" />
                  <path
        ...
        <div class="inline-flex shadow items-center flex-col justify-center py-5">
          <router-link to="/media/videos">
            <svg class="h-8 w-8 text-blue-500" xmlns="http://www.w3.org/2000/svg" id="Capa_1" enable-background="new 0 0 512 512" height="512" viewBox="0 0 512 512" width="512">
              <g>
                <path
                  fill="#2b6cb0"
                ...
                />
                <path fill="#2b6cb0" d="m263.508 132.841c0 21.125 17.186 38.311 38.311 38.311 21.124 0 38.311-17.186 38.311-38.311s-17.186-38.311-38.311-38.311-38.311 17.186-38.311 38.311zm61.592 0c0 12.837-10.444 23.281-23.281 23.281-12.838 0-23.282-10.444-23.282-23.281s10.444-23.282 23.282-23.282c12.837.001 23.281 10.445 23.281 23.282z" />
                <path fill="#2b6cb0" d="m154.925 186.162c14.929 0 27.074-12.146 27.074-27.074s-12.145-27.073-27.074-27.073c-14.928 0-27.074 12.145-27.074 27.073.001 14.929 12.146 27.074 27.074 27.074zm0-39.118c6.642 0 12.045 5.403 12.045 12.044 0 6.642-5.403 12.045-12.045 12.045-6.641 0-12.044-5.403-12.044-12.045 0-6.641 5.403-12.044 12.044-12.044z" />
                <path
                  fill="#2b6cb0"
                ...
                />
                <path fill="#2b6cb0" d="m282.778 406.998c-4.15 0-7.514 3.364-7.514 7.515s3.364 7.515 7.514 7.515h18.745c4.15 0 7.515-3.364 7.515-7.515s-3.364-7.515-7.515-7.515z" />
                <path fill="#2b6cb0" d="m232.979 406.998c-4.15 0-7.515 3.364-7.515 7.515s3.364 7.515 7.515 7.515h18.746c4.15 0 7.515-3.364 7.515-7.515s-3.364-7.515-7.515-7.515z" />
                <path fill="#2b6cb0" d="m183.179 406.998c-4.15 0-7.515 3.364-7.515 7.515s3.365 7.515 7.515 7.515h18.746c4.15 0 7.515-3.364 7.515-7.515s-3.364-7.515-7.515-7.515z" />
              </g>
            </svg>
        ...
        <div class="inline-flex shadow items-center flex-col justify-center py-5">
          <router-link to="/media/books">
            <svg class="h-8 w-8 text-blue-500" xmlns="http://www.w3.org/2000/svg" id="Layer_1" enable-background="new 0 0 512 512" height="512" viewBox="0 0 512 512" width="512">
              <g>
                <path fill="#2b6cb0" d="m88 456c-8.837 0-16-7.164-16-16v-374c0-36.393 29.607-66 66-66h286c8.837 0 16 7.164 16 16v368c0 8.836-7.163 16-16 16s-16-7.164-16-16v-352h-270c-18.748 0-34 15.252-34 34v374c0 8.836-7.163 16-16 16z" />
                <path fill="#2b6cb0" d="m424 512h-280c-39.701 0-72-32.299-72-72s32.299-72 72-72h280c8.837 0 16 7.164 16 16s-7.163 16-16 16h-280c-22.056 0-40 17.944-40 40s17.944 40 40 40h280c8.837 0 16 7.164 16 16s-7.163 16-16 16z" />
                <path fill="#2b6cb0" d="m424 456h-280c-8.837 0-16-7.164-16-16s7.163-16 16-16h280c8.837 0 16 7.164 16 16s-7.163 16-16 16z" />
                <path fill="#2b6cb0" d="m160 400c-8.837 0-16-7.164-16-16v-368c0-8.836 7.163-16 16-16s16 7.164 16 16v368c0 8.836-7.163 16-16 16z" />
              </g>
            </svg>
      ...
      <div id="media" class="max-w-4xl px-8 py-4 shadow-xl rounded-lg mt-12 bg-white mx-auto items-center justify-evenly h-38 hidden lg:flex lg:flex-row">
        <router-link to="/media/audio">
          <svg class="h-8 w-8 text-blue-500" xmlns="http://www.w3.org/2000/svg" id="Capa_1" enable-background="new 0 0 512.098 512.098" height="512px" viewBox="0 0 512.098 512.098" width="512px">
            <g>
              <g>
...
export default {
  ...
  methods: {
    ...
    youtube() {
      window.open("https://www.youtube.com/channel/UCPe9rUAnO_P7AFsswV7E2Qw", "_blank");
    },
    modalShow() {
