    ...
    <div class="grid lg:grid-cols-5 grid-cols-2 lg:px-0 px-3 col-gap-8 row-gap-24 mt-10">
      ...
      >
        ...
        <div class="flex justify-between w-full px-4 pb-2">
          <p style="font-size:.59rem" class="text-gray-400 font-normal tracking-tighter">$20</p>
          <p
            style="font-size:.57rem"
            class="leading-3 text-gray-700 font-light tracking-tight"
          >Add to cart</p>
        </div>
        <div class="rounded-md bg-gray-900 w-full flex justify-center items-center mt-3">
          <p class="text-white text-xs py-2">Buy Now</p>
        </div>
      </div>
    </div>
