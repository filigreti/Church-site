<template>
  <main id="salvations">
    <Hero
      ...
      :bgImage="'https://images.unsplash.com/photo-1422065649003-cf6684a31468?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1648&q=80'"
    />
    <div class="mt-6">
          ...
          <form @submit.prevent="send" class="py-8">
            ...
            <div class="max-w-xl mx-auto">
              <vue-tel-input
                ...
                class="mt-3"
                v-model.trim="info.mobile_number"
              ></vue-tel-input>
            </div>
            ...
            <div class="max-w-xl mx-auto">
              <textarea
                rows="5"
                class="bg-gray-200 mt-4 text-xs font-light focus:outline-none focus:shadow-outline border-0 border-gray-300 rounded-lg py-2 px-4 w-full block mx-auto appearance-none leading-6"
                type="email"
                placeholder=" Address"
