<template>
  <main id="theme">
    <Hero
      :color="'bg-indigo-800'"
      :bgImage="
        'https://images.unsplash.com/photo-1571751888410-0c83afb6f3f0?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1650&q=80'
      "
    />
    <div
    ...
    >
      ...
      <div class="lg:ml-10 h-full flex-1">
        <h1 class="uppercase text-2xl font-light tracking-wider">
          {{ getCurrentEvent.event_title }}
        </h1>
        <h1 class="uppercase text-2xl font-light tracking-wider leading-6">
          Theme: {{ getCurrentEvent.event_theme }}
        </h1>
        <div
          v-if="getCurrentEvent.event_time !== null"
          class="flex mt-4 w-full lg:flex flex-col"
        >
          <div class="flex items-center mb-4">
            ...
            <div class="ml-2 lg:block flex">
              <p class="text-sm font-light">
                Arrival time, {{ getCurrentEvent.event_start_date }},
                {{ getCurrentEvent.event_time }}
              </p>
          ...
          <div class="flex items-center lg:mt-0 mt-3">
            ...
            <div
              class="ml-2 lg:flex lg:flex-col flex-row leading-4 lg:leading-5"
            >
              <span class="text-sm font-light">{{
                getCurrentEvent.address
              }}</span>
        ...
        <div class="flex">
          ...
          >
            <div class="inline-flex flex-col items-center">
              ...
              >
                {{ getCurrentEvent.event_start_date | convertDate }}
              </h1>
              <h2 class="text-blue-500 font-normal tracking-wide leading-none">
                {{ getCurrentEvent.event_start_date | convertMonth }}
              </h2>
            </div>
          </div>
          <div
          ...
          >
            <div class="inline-flex flex-col items-center">
              <h1
                ...
                class="text-2xl font-black leading-none tracking-wider"
              >
                {{ getCurrentEvent.event_end_date | convertDate }}
              </h1>
              <h2 class="text-blue-500 font-normal tracking-wide leading-none">
                {{ getCurrentEvent.event_end_date | convertMonth }}
              </h2>
            </div>
          </div>
        </div>
    ...
    <div class="bg-blue-100 bg-opacity-25 py-16">
      <div
        class="lg:max-w-4xl lg:mx-auto bg-white rounded-lg shadow-xl mx-3 lg:px-0 px-8"
      >
        <form @submit.prevent="send" class="py-8">
          ...
          <p class="mt-3 text-gray-600 text-xs text-center font-light">
            Fill in your Detail so we can welcome you properly
          </p>
          <div
            class="max-w-xl mt-5 mx-auto grid grid-cols-1 lg:grid-cols-2 lg:gap-5 gap-2"
          >
            <input
          ...
          <div
            class="max-w-xl mt-3 mx-auto grid grid-cols-1 lg:grid-cols-2 lg:gap-5 gap-2"
          >
            <input
              class="bg-gray-200 text-xs rounded-full font-light focus:outline-none focus:shadow-outline border-0 border-gray-300 rounded-lg py-2 px-4 w-full block mx-auto appearance-none leading-6"
              type="string"
          ...
          >
            ...
            <div class="text-xs font-light text-gray-800 lg:mr-24">
          ...
          >
            <div class="text-xs font-light text-gray-800 lg:mr-24">
              Choose a workshop class you like to join ?
            </div>
            <div class="relative flex items-center">
              <select
              ...
              >
                ...
                <option v-for="(workshop, i) in allWorkshops" :key="i">{{
                  workshop
                }}</option>
              </select>
              <svg
