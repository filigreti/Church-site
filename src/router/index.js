...
const routes = [{
    ...
    },
    {
        ...
        children: [{
                ...
                name: "MainEvent",
                component: () =>
                    import ("../views/MainEvents.vue"),
            },
            {
                path: ":theme",
                name: "MainTheme",
                component: () =>
                    import ("../views/Theme.vue"),
            },
        ],
    },
    {
        ...
        children: [{
            ...
            },
            {
                ...
                children: [{
                        ...
                        name: "Books",
                        component: () =>
                            import ("../components/AllBooks.vue"),
                    },
                    {
                        path: "view-book",
                        name: "ViewBook",
                        component: () =>
                            import ("../components/ViewBook.vue"),
                    },
                    {
                        path: "cart",
                        name: "Cart",
